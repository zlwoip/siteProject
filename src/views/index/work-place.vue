...
export default {
  ...
  computed: {
    ...
    isShowMore() {
      return this.waitingItmes.length > 2
    }
  },
  mounted() {
    this.tempWaitingItems = this.waitingItmes.length > 2 ? this.waitingItmes.slice(0, 2) : this.waitingItmes
  },
  methods: {
    toggleMore() {
      ...
      if (this.showWatingMode) {
        ...
        this.tempWaitingItems = this.waitingItmes.slice(0, 2)
      }
    },
